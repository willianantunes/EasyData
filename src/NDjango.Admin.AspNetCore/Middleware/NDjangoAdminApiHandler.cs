...
{
    public class NDjangoAdminApiHandler
    {
        ...
        /// <summary>
        /// An instance of NDjango.AdminsManager that incapsulates all business logic of NDjango.Admin API
        /// </summary>
        protected readonly NDjangoAdminManager Manager;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NDjangoAdminApiHandler"/> class.
        /// </summary>
        /// <param name="manager">The instance of NDjangoAdminManager that incapsulates all business logic of NDjango.Admin API.</param>
        /// <param name="options"> Some options that affects handler's behavior.</param>
        /// <param name="httpContext">The current HttpContext.</param>
        public NDjangoAdminApiHandler(NDjangoAdminManager manager, NDjangoAdminOptions options, HttpContext httpContext)
        {
            Manager = manager;
            Options = options;
        ...
        public virtual async Task HandleGetModelAsync(string modelId, CancellationToken ct = default)
        {
            ...
            catch (NDjangoAdminManagerException ex) {
        ...
        protected virtual async Task WriteFetchDatasetResponseAsync(JsonWriter jsonWriter, NDjangoAdminResultSet result, long? total, CancellationToken ct)
        {
            if (total.HasValue) {
        ...
        /// <summary>
        /// Handles exceptions that might occur inside any other NDjango.Admin API request handler.
