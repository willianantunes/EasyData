...
namespace NDjango.Admin.Export
{
    ...
    public class BasicDataExportSettings : IDataExportSettings
    {
        ...
        private Func<NDjangoAdminRow, BeforeRowAddedCallback, CancellationToken, Task> _beforeRowAdded;

        public Func<NDjangoAdminRow, BeforeRowAddedCallback, CancellationToken, Task> BeforeRowAdded {
            get => _beforeRowAdded;
            set {
