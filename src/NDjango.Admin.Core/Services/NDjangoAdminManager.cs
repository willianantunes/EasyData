...
{
    public abstract class NDjangoAdminManager : IDisposable
    {
        ...
        public NDjangoAdminManager(IServiceProvider services, NDjangoAdminOptions options)
        {
            Services = services;
            Options = options;
        }
        ...
        public abstract Task<NDjangoAdminResultSet> FetchDatasetAsync(
